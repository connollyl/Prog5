    ...
    <div style="text-align: center">
        <div style="display: inline-block">
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:SqlDataSource ID="SDSServer" runat="server" ConnectionString="<%$ ConnectionStrings:UWPCS3870ConnectionStringServer %>" SelectCommand="SELECT * FROM [Users]"></asp:SqlDataSource>
                    </td>
                    <td>
