    ...
    <div style="text-align: center">
        <div style="display: inline-block">
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:SqlDataSource ID="SDSServer" runat="server" ConnectionString="<%$ ConnectionStrings:UWPCS3870ConnectionStringServer %>" InsertCommand="insert into Users (Username, Password, Email) values (@username, @password, @email)" SelectCommand="SELECT * FROM [Users] where Username=' +txtbxUsername.Text+ '">
                            <InsertParameters>
